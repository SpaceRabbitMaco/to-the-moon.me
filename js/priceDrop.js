...
function $drawTable($arr, $type, $ccTotalCount, $BTC_PRICE) { // start
   ...
   for (var i = 0; i < $arr.length; i++) {
      ...
      $htmlData = $htmlData + '<tr><td class="td-pos table-td1">' + rank + '</td><td class="td-name table-td2"><img src="https://s2.coinmarketcap.com/static/img/coins/16x16/' + id + '.png"  alt="Bitcoin" height="16" width="16"><a target="_blank" href="https://coinmarketcap.com/currencies/' + slug + '/">' + name + '</a></td><td class="td-abr table-td3">' + symbol + '</td><td class="td-sat table-td4">' + eqvBTC + '</td><td class="td-price table-td5"><a target="_blank" href="https://coinmarketcap.com/assets/' + slug + '/#markets">' + usdPrice + '</a></td><td class="td-volume-24 table-td6">' + volume_24h + '<td class="td-1h-change table-td7">' + change1h + '</td><td class="td-24h-change table-td8">' + change24h + '</td><td class="td-7d-change table-td9">' + change7d + '</td></tr>';
   }
